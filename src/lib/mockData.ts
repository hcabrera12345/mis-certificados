...
export const MOCK_COURSES: Course[] = [
  {
    ...
    description: 'Capacitación profesional oficial en marcos normativos, responsabilidad algorítmica, cumplimiento regulatorio y ética aplicada a la Inteligencia Artificial.',
    academic_hours: 50,
  ...
  },
  {
    ...
    description: 'Desarrollo de agentes inteligentes autónomos, automatización de procesos corporativos e ingeniería de IA para empresas y negocios (Brochure Oficial PDF).',
    academic_hours: 40,
    instructor_name: 'Directorio Ejecutivo Quinto',
    price_usd: 50.00,
    image_url: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=600',
    category: 'Agentes & Negocios',
    total_students: 30,
    is_active: true
  },
  {
...
export const INITIAL_RECEIPTS: PaymentReceipt[] = [
  {
    ...
    course_id: 'c-002',
    course_title: 'CURSO 2 GOBERNANZA Y ETICA APLICADA A IA',
